...
const UniCv = () => {
    ...
    const translations = {
        en: {
            ...
            about: "ABOUT",
            aboutText: "In 2016, I began my studies at the Faculty of Electronics and Information Technology at Warsaw University of Technology, pursuing a degree in Computer Science taught in English. During my first year, I was a member of the Faculty Student Council of EiTI and delegated to the Information and Promotion Committee (KIP). In the third semester, I decided to learn the Java programming language, and shortly thereafter, I obtained my first job in the industry. In the following years, I balanced my professional development with academic responsibilities. I advanced in the corporate ladder, which required greater commitment to my professional work, resulting in a delay in completing my undergraduate studies. Finally, in 2022, I submitted my thesis titled \"Exploring the COVID-19 Patient Database and Developing an Expert System\" and passed the exam with a result above good.\n\nCurrently, I work as a programmer in the position of Senior Software Engineer at the newly opened branch of the international corporation Visa. My responsibilities include maintaining and developing web applications. My plan is to advance in the field of distributed systems architecture and explore how artificial intelligence (AI) can change the world and impact the services offered to end users.\n\nDespite working on systems and applications, I do not shy away from manual tasks such as building circuits, connecting cables, or soldering.\n\nMy expectations for my master's studies are to expand my knowledge in system development and artificial intelligence. I seek to work on engaging projects that provide opportunities for creative thinking and encourage the effort involved in acquiring new knowledge."
        },
        pl: {
            contact: "KONTAKT",
            education: "EDUKACJA",
            ...
            about: "O MNIE",
            aboutText: "W 2016 roku rozpocząłem studia na Wydziale Elektroniki i Technik Informacyjnych Politechniki Warszawskiej, na kierunku Informatyka prowadzonym w języku angielskim. W pierwszym roku byłem członkiem Wydziałowej Rady Studentów EiTI i delegatem do Komisji Informacji i Promocji (KIP). W trzecim semestrze zdecydowałem się nauczyć języka programowania Java, a wkrótce potem otrzymałem swoją pierwszą pracę w branży. W kolejnych latach łączyłem rozwój zawodowy z obowiązkami akademickimi. Awansowałem w hierarchii korporacyjnej, co wymagało większego zaangażowania w pracę zawodową, co skutkowało opóźnieniem w ukończeniu studiów licencjackich. Ostatecznie w 2022 roku obroniłem pracę dyplomową pt. \"Eksploracja bazy danych pacjentów COVID-19 i opracowanie systemu eksperckiego\" i zdałem egzamin z wynikiem powyżej dobrego.\n\nObecnie pracuję jako programista na stanowisku Senior Software Engineer w nowo otwartym oddziale międzynarodowej korporacji Visa. Moje obowiązki obejmują utrzymanie i rozwój aplikacji webowych. Moim planem jest rozwój w dziedzinie architektury systemów rozproszonych oraz eksploracja tego, jak sztuczna inteligencja (AI) może zmienić świat i wpłynąć na usługi oferowane użytkownikom końcowym.\n\nPomimo pracy nad systemami i aplikacjami, nie stronię od zadań manualnych, takich jak budowanie obwodów, podłączanie kabli czy lutowanie.\n\nMoje oczekiwania wobec studiów magisterskich to poszerzenie wiedzy w zakresie rozwoju systemów i sztucznej inteligencji. Szukam pracy nad angażującymi projektami, które dają możliwości kreatywnego myślenia i zachęcają do wysiłku związanego z nabywaniem nowej wiedzy."
        }
    };
